...
class VoteyThumbs(commands.Cog):
    ...
    async def cog_unload(self) -> None:
        self.bot.tree.remove_command(self.voteythumbs_menu.name, type=self.voteythumbs_menu.type)
    ...
    async def voteythumbs_context(self, interaction: discord.Interaction, message: discord.Message):
        """ Starts a 👍 👎 vote. """
    ...
    async def voteythumbs_command(self, interaction: discord.Interaction, question: str):
        """ Starts a 👍 👎 vote. """
